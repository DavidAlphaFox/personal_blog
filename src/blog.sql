...
INSERT INTO "users" VALUES('p.donadeo@gmail.com','55385dcf64f27315d10dbbd22c57276271e0e5b6','Paolo','Donadeo','paolo','Paolo Donadeo',1,'admin','http://www.donadeo.net');
INSERT INTO "users" VALUES('pippo@pluto.com','aa281eb2aa74cf3be4d385475c9e6d9e6281cde5',NULL,NULL,NULL,NULL,1,'admin',NULL);
CREATE TABLE posts
(
...
INSERT INTO "posts" VALUES(101,'p.donadeo@gmail.com','2009-02-11 16:05:40','2009-02-11 16:05:40','post',1,'Titolo del post','titolo-del-post','Contenuto del post. Questo è un post molto bello, trallallà. 5 € grazie!','Un post interessante',1,1,0,NULL);
INSERT INTO "posts" VALUES(102,'p.donadeo@gmail.com','2009-02-11 17:05:40','2009-02-11 17:05:40','post',1,'Titolo del post2','titolo-del-post2','Contenuto secondo del post. Questo è un post molto bello, trallallà. Stavolta 15 € grazie!','Un post ancora più interessante',1,1,0,NULL);
...
INSERT INTO "comments" VALUES(1001,101,'Paolo Donadeo','p.donadeo@gmail.com',NULL,'192.168.1.1','Mozilla pippo 3.14','2009-02-11 22:06:35','Questo è un commento',1);
INSERT INTO "comments" VALUES(12131,102,'Paolo Donadeo','p.donadeo@gmail.com','http://www.donadeo.net','192.168.1.101','Mozilla pippo 3.14','2009-02-11 22:07:11','Questo è un commento',1);
INSERT INTO "comments" VALUES(121310,102,'Gigia','gigia@gmail.com','http://www.gigia.net','192.168.200.101','Interdet Exploder','2009-02-11 22:16:57','Questo è un commento UTF-8: à€!',0);
CREATE TABLE tags
(
